...
function OrdersTab() {
  ...
  const [returnModalFor, setReturnModalFor] = useState(null); // order object
  ...
  const handleReturnSuccess = (rr) => {
    setOrders((cur) => cur.map((o) => (
      o._id === returnModalFor?._id ? { ...o, status: 'return_requested' } : o
    )));
    setReturnModalFor(null);
    toast('Return request submitted — we\'ll review it within 24–48 hours');
  };
